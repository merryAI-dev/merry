...
### 2단계: 사용자 확인 받기 (MANDATORY)
**반드시 사용자에게 분석 결과를 확인받아야 합니다!**
...
위 분석을 바탕으로 다음 방향으로 유사 기업을 검색하려 합니다:
- **1차 Peer**: Salesforce, HubSpot (글로벌 CRM SaaS)
- **2차 Peer**: 더존비즈온, 카카오엔터프라이즈 (국내 B2B SaaS)

**위 분석이 맞습니까? 다른 방향으로 검색할까요?**
```

### 3단계: Peer 기업 확정 및 PER 조회
사용자가 확인/수정 후:
1. 사용자와 함께 최종 Peer 기업 선정
2. **즉시** analyze_peer_per 도구 호출
