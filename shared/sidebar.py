...
def _reset_session():
    ...
    st.session_state.report_input_quality = {
        "score": 0,
        "status": "needs_more",
        "missing": [],
    }
    st.session_state.report_chapters = {}
    st.session_state.report_chapter_order = []
    st.session_state.report_chapter_index = 0
    st.session_state.report_chapter_status = {}
    st.session_state.report_edit_buffer = ""
    st.session_state.report_outline = [
        ...
        "  2. 향후 사업 전략 및 계획",
        "  3. 핵심 자원 및 프로세스",
        "  4. 이해관계자의 가치 제안(Stakeholder Value Proposition)",
        "  5. 사업화 전략 분석",
        "V. 투자 적합성 및 임팩트",
        "  1. 투자 적합성",
        "  2. 투자 포인트",
        ...
        "  4. SDGs 연계 및 임팩트 측정",
        "VI. 수익성/Valuation",
        "  1. 손익 추정(회사 제시/심사역 추정)",
        "  2. 기업가치평가 및 수익성 분석",
        "  2.1 Peer Group 및 Valuation 방법 선정",
        "  2.3 Exit 전략",
        "VII. 임팩트 리스크",
        "VIII. 종합 결론",
    ]
